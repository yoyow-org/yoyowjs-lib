...
var Serializer = function () {
    function Serializer(operation_name, types) {
        var compare = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    ...
    Serializer.prototype.toObject = function toObject() {
        ...
        try {
            ...
            for (var i = 0, field; i < iterable.length; i++) {
                ...
                //if (field === "extensions" && this.isEmptyObject(object))continue;
                result[field] = object;
                if (HEX_DUMP) {
    ...
    Serializer.prototype.isEmptyObject = function isEmptyObject(e) {
        var t;
        for (t in e) {
            return !1;
        }return !0;
