...
var Signature = function () {
    ...
    Signature.prototype.recoverPublicKeyFromBuffer = function recoverPublicKeyFromBuffer(buffer) {
        return this.recoverPublicKey(_hash3.default.sha256(buffer));
    };
    ...
    Signature.signBuffer = function signBuffer(buf, private_key) {
        var _hash = _hash3.default.sha256(buf);
    ...
    Signature.prototype.verify = function verify(string, public_key) {
        return this.verifyBuffer(new Buffer(string), public_key);
    };
