...
var PrivateKey = function () {
    ...
    */
    ...
    PrivateKey.fromSeed = function fromSeed(seed) {
        ...
        return PrivateKey.fromBuffer(_hash2.default.sha256(seed));
    };
    ...
    PrivateKey.fromWif = function fromWif(_private_wif) {
        ...
        var new_checksum = _hash2.default.sha256(private_key);
        new_checksum = _hash2.default.sha256(new_checksum);
    ...
    PrivateKey.prototype.toWif = function toWif() {
        ...
        var checksum = _hash2.default.sha256(private_key);
    ...
    */
    ...
    PrivateKey.prototype.get_shared_secret = function get_shared_secret(public_key) {
        ...
        */
        ...
        return _hash2.default.sha512(S);
    };
