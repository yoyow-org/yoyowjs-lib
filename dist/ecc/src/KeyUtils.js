...
var key = {
    ...
    */
    aes_checksum: function aes_checksum(password) {
        ...
        while (Date.now() - start_t < HASH_POWER_MILLS) {
            secret = _hash2.default.sha256(secret);
            iterations += 1;
        }
    ...
    */
    aes_private: function aes_private(password, key_checksum) {
        ...
        var new_checksum = _hash2.default.sha256(secret);
    ...
    */
    random32ByteBuffer: function random32ByteBuffer() {
        ...
        while (Date.now() - start_t < HASH_POWER_MILLS) {
            entropy = _hash2.default.sha256(entropy);
        }var hash_array = [];
        ...
        hash_array.push(randomBuffer != null ? new Buffer(randomBuffer) : _secureRandom2.default.randomBuffer(32));

        return _hash2.default.sha256(Buffer.concat(hash_array));
    },
    ...
    get_random_key: function get_random_key(entropy) {
        ...
        return _PrivateKey2.default.fromBuffer(this.random32ByteBuffer(entropy, randomBuffer));
    },
    get_brainPrivateKey: function get_brainPrivateKey(brainKey) {
        ...
        return _PrivateKey2.default.fromBuffer(_hash2.default.sha256(_hash2.default.sha512(brainKey + " " + sequence)));
    },
    ...
    browserEntropy: function browserEntropy() {
        ...
        try {
            ...
            entropyStr = _hash2.default.sha256(new Date().toString());
        }
