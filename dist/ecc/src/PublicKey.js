...
var PublicKey = function () {
    ...
    PublicKey.prototype.toBlockchainAddress = function toBlockchainAddress() {
        ...
        var pub_sha = _hash2.default.sha512(pub_buf);
        return _hash2.default.ripemd160(pub_sha);
    };
    ...
    */
    ...
    PublicKey.prototype.toPublicKeyString = function toPublicKeyString() {
        ...
        var pub_buf = this.toBuffer();
        var checksum = _hash2.default.ripemd160(pub_buf);
    ...
    */
    ...
    PublicKey.fromStringOrThrow = function fromStringOrThrow(public_key) {
        ...
        var new_checksum = _hash2.default.ripemd160(public_key);
    ...
    PublicKey.prototype.toAddressString = function toAddressString() {
        ...
        var pub_buf = this.toBuffer();
        var pub_sha = _hash2.default.sha512(pub_buf);
        var addy = _hash2.default.ripemd160(pub_sha);
        var checksum = _hash2.default.ripemd160(addy);
    ...
    PublicKey.prototype.toPtsAddy = function toPtsAddy() {
        var pub_buf = this.toBuffer();
        var pub_sha = _hash2.default.sha256(pub_buf);
        var addy = _hash2.default.ripemd160(pub_sha);
        addy = Buffer.concat([new Buffer([0x38]), addy]); //version 56(decimal)

        var checksum = _hash2.default.sha256(addy);
        checksum = _hash2.default.sha256(checksum);
    ...
    PublicKey.prototype.child = function child(offset) {
        ...
        offset = _hash2.default.sha256(offset);
