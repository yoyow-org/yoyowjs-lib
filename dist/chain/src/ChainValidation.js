...
var _AccountUtils = require('./AccountUtils');
...
var chainValidation = {
    ...
    is_account_uid: function is_account_uid(value) {
        if (this.is_empty(value)) return false;
        return _AccountUtils2.default.validAccountUID(value);
    },
