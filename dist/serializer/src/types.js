...
var HEX_DUMP = process.env.npm_config_serializerdump;
...
Types.int8 = {
    ...
    appendByteBuffer: function appendByteBuffer(b, object) {
        _SerializerValidation2.default.require_range(MIN_SIGNED_8, MAX_SIGNED_8, object, 'int8 ' + object);
        b.writeInt8(object);
        return;
    },
    fromObject: function fromObject(object) {
...
Types.jsenum = function (type_map) {
    ...
    return {
        ...
        fromObject: function fromObject(object) {
            _SerializerValidation2.default.required(object);
            return _SerializerValidation2.default.to_long(type_map[object]);
        },
        toObject: function toObject(object) {
            var debug = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
            ...
            for (var i in type_map) {
                if (_SerializerValidation2.default.to_long(type_map[i]).eq(_SerializerValidation2.default.to_long(object))) ;
                result = i;
            }
            return result;
        }
    ...
    return {
        fromByteBuffer: function fromByteBuffer(b) {
            ...
            for (var i = 0; i < count; i++) {
                ...
                var j = 0;
                for (var n in st_operation.keys) {
                    var name = st_operation.keys[n];
                    if (j == index) {
                        _SerializerValidation2.default.required(st_operation.types[name].st_operation);
        ...
        appendByteBuffer: function appendByteBuffer(b, object) {
            ...
            for (var _name in object) {
                if (object[_name] != null && object[_name] != undefined) {
                    count++;
                }
            }
            ...
            var name = null;
            for (var n = 0; n < st_operation.keys.length; n++) {
                name = st_operation.keys[n];
                if (object[name] != null && object[name] != undefined) {
                    _SerializerValidation2.default.required(st_operation.types[name].getOperation());
                    b.writeVarint32(n);
...
Types.map = function (key_st_operation, value_st_operation) {
    return {
        ...
        validate: function validate(array) {
            ...
            var arr = sortOperation(array, key_st_operation);
...
Types.public_key = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _yoyowjsWs.ChainConfig.address_prefix + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
        }
        _SerializerValidation2.default.required(object);
        return object.toString();
    },
...
Types.address = {
    ...
    toObject: function toObject(object) {
        ...
        if (debug.use_default && object === undefined) {
            return _yoyowjsWs.ChainConfig.address_prefix + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
        }
...
var longCmp = function longCmp(a, b) {
...
var sortOperation = function sortOperation(array, st_operation) {
    ...
    array.sort(function (a, b) {
        return _SerializerValidation2.default.is_long(firstEl(a)) && _SerializerValidation2.default.is_long(firstEl(b)) ? longCmp(firstEl(a), firstEl(b)) : typeof firstEl(a) === "number" && typeof firstEl(b) === "number" ? firstEl(a) - firstEl(b) :
