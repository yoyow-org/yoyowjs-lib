...
var {
    ...
    protocol_id_type, object_id_type, vote_id,name,
    future_extensions,
...
export { operation };
// For module.exports
var Serializer = function (operation_name, serilization_types_object, compare) {
 ...
 * @type {Serializer}
 */
export const account_manage_operation_fee_parameters = new Serializer(
 ...
 * @type {Serializer}
 */
export const account_update_auth_operation_fee_parameters = new Serializer(
    "account_update_auth_operation_fee_parameters",
    {
        fee: uint64,
        price_per_auth: uint32,
        min_real_fee: uint64,
...
export const account_update_key_operation_fee_parameters = new Serializer(
    "account_update_key_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const account_update_proxy_operation_fee_parameters = new Serializer(
    "account_update_proxy_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const csaf_collect_operation_fee_parameters = new Serializer(
...
export const csaf_lease_operation_fee_parameters = new Serializer(
    "csaf_lease_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const committee_member_vote_update_operation_fee_parameters = new Serializer(
    "committee_member_vote_update_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const committee_proposal_create_operation_fee_parameters = new Serializer(
    "committee_proposal_create_operation_fee_parameters",
    {
        basic_fee: uint64,
        price_per_item: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
        extensions: optional(future_extensions)
    }
...
export const committee_proposal_update_operation_fee_parameters = new Serializer(
    "committee_proposal_update_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const witness_vote_update_operation_fee_parameters = new Serializer(
    "witness_vote_update_operation_fee_parameters",
    {
        basic_fee: uint64,
        price_per_witness: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint64,
        extensions: optional(future_extensions)
    }
...
export const witness_collect_pay_operation_fee_parameters = new Serializer(
    "witness_collect_pay_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint64,
...
export const witness_report_operation_fee_parameters = new Serializer(
    "witness_report_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint64,
...
export const post_operation_fee_parameters = new Serializer(
...
export const post_update_operation_fee_parameters = new Serializer(
    "post_update_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const platform_create_operation_fee_parameters = new Serializer(
    "platform_create_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const platform_update_operation_fee_parameters = new Serializer(
    "platform_update_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const platform_vote_update_operation_fee_parameters = new Serializer(
    "platform_vote_update_operation_fee_parameters",
    {
        basic_fee: uint64,
        price_per_platform:uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
        extensions: optional(future_extensions)
    }
...
export const account_auth_platform_operation_fee_parameters = new Serializer(
    "account_auth_platform_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee:uint64,
        min_rf_percent: uint16,
...
export const account_cancel_auth_platform_operation_fee_parameters = new Serializer(
...
export const account_enable_allowed_assets_operation_fee_parameters = new Serializer(
    "account_enable_allowed_assets_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint64,
...
export const account_update_allowed_assets_operation_fee_parameters = new Serializer(
    "account_update_allowed_assets_operation_fee_parameters",
    {
        fee: uint64
    }
);
...
export const score_create_operation_fee_parameters = new Serializer(
    "score_create_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const reward_operation_fee_parameters = new Serializer(
...
export const reward_proxy_operation_fee_parameters = new Serializer(
    "reward_proxy_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const buyout_operation_fee_parameters = new Serializer(
    "buyout_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const license_create_operation_fee_parameters = new Serializer(
...
export const advertising_create_operation_fee_parameters = new Serializer(
    "advertising_create_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const advertising_update_operation_fee_parameters = new Serializer(
    "advertising_update_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const advertising_buy_operation_fee_parameters = new Serializer(
...
export const advertising_confirm_operation_fee_parameters = new Serializer(
    "advertising_confirm_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const advertising_ransom_operation_fee_parameters = new Serializer(
    "advertising_ransom_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const custom_vote_create_operation_fee_parameters = new Serializer(
    "custom_vote_create_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const custom_vote_cast_operation_fee_parameters = new Serializer(
    "custom_vote_cast_operation_fee_parameters",
    {
        fee: uint64,
        price_per_output: uint32,
        min_real_fee: uint64,
...
export const balance_lock_update_operation_fee_parameters = new Serializer(
    "balance_lock_update_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const pledge_mining_update_operation_fee_parameters = new Serializer(
    "pledge_mining_update_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const pledge_bonus_collect_operation_fee_parameters = new Serializer(
    "pledge_bonus_collect_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
export const market_fee_collect_operation_fee_parameters = new Serializer(
    "market_fee_collect_operation_fee_parameters",
    {
        fee: uint64,
        price_per_kbyte:uint32,
        min_real_fee: uint64,
...
export const score_bonus_collect_operation_fee_parameters = new Serializer(
    "market_fee_collect_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
...
export const beneficiary_assign_operation_fee_parameters = new Serializer(
    "market_fee_collect_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
...
export const benefit_collect_operation_fee_parameters = new Serializer(
    "benefit_collect_operation_fee_parameters",
    {
        fee: uint64,
        min_real_fee: uint64,
        min_rf_percent: uint16,
...
var fee_parameters = static_variant([
    ...
    platform_vote_update_operation_fee_parameters,
    account_auth_platform_operation_fee_parameters,
    account_cancel_auth_platform_operation_fee_parameters,
    asset_create_operation_fee_parameters,
    asset_update_operation_fee_parameters,
    asset_issue_operation_fee_parameters,
    asset_reserve_operation_fee_parameters,
    ...
    limit_order_create_operation_fee_parameters,
    limit_order_cancel_operation_fee_parameters,
    fill_order_operation_fee_parameters,  // VIRTUAL
    market_fee_collect_operation_fee_parameters,
    score_bonus_collect_operation_fee_parameters,
    beneficiary_assign_operation_fee_parameters,
    benefit_collect_operation_fee_parameters
]);
...
export const account_uid_auth = new Serializer(
    "account_uid_auth", {
        uid: account_uid_type,
        auth_type: jsenum({ owner_auth: 0, active_auth: 1, secondary_auth: 2 })
    }, (a, b) => a.uid.gt(b.uid) ? 1 : a.uid.lt(b.uid) ? -1 : 0
);
 ...
 * @type {Serializer}
 */
export const transfer_option = new Serializer(
    "transfer_option", {
 ...
 * @type {Serializer}
 */
export const account_reg_info = new Serializer(
    "account_reg_info", {
 ...
 * @type {Serializer}
 */
export const account_manage_options = new Serializer(
    "account_manage_options", {
 ...
 * @type {Serializer}
 */
export const account_manage = new Serializer(
    "account_manage", {
        fee: fee,                                   // 手续费
 ...
 * @type {Serializer}
 */
export const account_update_auth = new Serializer(
    "account_update_auth", {
        fee: fee,                               // 手续费
 ...
 * @type {Serializer}
 */
export const account_update_key = new Serializer(
    "account_update_key", {
        fee: fee,                               // 手续费
 ...
 * @type {Serializer}
 */
export const account_update_proxy = new Serializer(
 ...
 * @type {Serializer}
 */
export const csaf_collect = new Serializer(
    "csaf_collect", {
        fee: fee,                               // 手续费
 ...
 * @type {Serializer}
 */
export const csaf_lease = new Serializer(
    "csaf_lease", {
        fee: fee,                               // 手续费
 ...
 * @type {Serializer}
 */
export const committee_member_vote_update = new Serializer(
    "committee_member_vote_update",
    {
        fee: fee,                                           // 手续费
 ...
 * @type {Serializer}
 */
export const account_priviledge_update_options = new Serializer(
    "account_priviledge_update_options", {
 ...
 * @type {Serializer}
 */
export const committee_update_account_priviledge_item_type = new Serializer(
 ...
 * @type {Serializer}
 */
export const committee_update_fee_schedule_item_type = new Serializer(
 ...
 * @type {Serializer}
 */
export const committee_update_global_parameter_item_type = new Serializer(
 ...
 * 提案内容单项
 */
var committee_proposal_item_type = static_variant([
    committee_update_account_priviledge_item_type,  // 账户权限管理类提案单项
 ...
 * 表决意见
 */
var opinion_against = -1, opinion_neutral = 0, opinion_for = 1;
var voting_opinion_type = static_variant([
    opinion_against,    // 反对
    opinion_neutral,    // 中立
    opinion_for         // 赞成
])
 ...
 * @type {Serializer}
 */
export const committee_proposal_create = new Serializer(
 ...
 * @type {Serializer}
 */
export const committee_proposal_update = new Serializer(
    "committee_proposal_update", {
        fee: fee,                               // 手续费
 ...
 * @type {Serializer}
 */
export const witness_vote_update = new Serializer(
    "witness_vote_update", {
        fee: fee,                                       // 手续费
 ...
 * @type {Serializer}
 */
export const witness_collect_pay = new Serializer(
    "witness_collect_pay", {
        fee: fee,                                   // 手续费
        witness_account: account_uid_type,          // 见证人账号
        pay: asset,                                 // 领取金额
 ...
 * @type {Serializer}
 */
export const witness_report = new Serializer(
    "witness_report", {
        fee: fee,                                   // 手续费
...
export const Recerptor_Parameter = new Serializer(
    "Recerptor_Parameter", {
        cur_ratio: uint16,
        to_buyout:bool,
        buyout_ratio: uint16,
...
export const post_extensions = new Serializer(
    "post_extensions", {
...
export const post_update_extensions = new Serializer(
    "post_update_extensions", {
        forward_price: optional(share_type),
 ...
 * @type {Serializer}
 */
export const post = new Serializer(
    "post", {
        fee: fee,                                   // 手续费
 ...
 * @type {Serializer}
 */
export const post_update = new Serializer(
    "post_update", {
        fee: fee,                                                      // 手续费
        platform: account_uid_type,                                    // 平台账号
        poster: account_uid_type,                                      // 作者账号
 ...
 * @type {Serializer}
 */
export const platform_create = new Serializer(
    "platform_create", {
        fee: fee,                               // 手续费
        account: account_uid_type,              // 账号
        pledge: asset,                          // 押金
 ...
 * @type {Serializer}
 */
export const platform_update = new Serializer(
    "platform_update", {
        fee: fee,                               // 手续费
        account: account_uid_type,              // 账号
        new_pledge: optional(asset),            // 新的押金（可选）
 ...
 * @type {Serializer}
 */
export const platform_vote_update = new Serializer(
    "platform_vote_update", {
        fee: fee,                                   // 手续费
        voter: account_uid_type,                    // 投票人账号
...
export const account_auth_platform_ext = new Serializer(
    "account_auth_platform_ext", {
...
export const account_auth_platform = new Serializer(
 ...
 * @type {Serializer}
 */
export const account_cancel_auth_platform = new Serializer(
 ...
 * @type {Serializer}
 */
export const asset_create_option = new Serializer(
    "asset_create_option",
    {
 ...
 * @type {Serializer}
 */
export const account_enable_allowed_assets = new Serializer(
    "account_enable_allowed_assets",
    {
        fee: fee,                               // 手续费
 ...
 * 更新账户端资产白名单
 */
export const account_update_allowed_assets = new Serializer(
    "account_update_allowed_assets",
    {
        fee: fee,                               // 手续费
        account: account_uid_type,              // 账户
...
export const score_create = new Serializer(
    "score_create",
    {
        fee: fee,
...
export const reward = new Serializer(
    "reward",
    {
        fee: fee,
        from_account_uid: account_uid_type,
...
export const reward_proxy = new Serializer(
    "reward_proxy",
    {
        fee: fee,
        from_account_uid: account_uid_type,
...
export const buyout = new Serializer(
    "buyout",
    {
        fee: fee,
        from_account_uid: account_uid_type,
...
export const license_create = new Serializer(
    "license_create",
    {
        fee: fee,
...
export const advertising_create = new Serializer(
    "advertising_create",
    {
        fee: fee,
...
export const advertising_update = new Serializer(
    "advertising_update",
    {
        fee: fee,
        platform: account_uid_type,                 // 平台账号
...
export const advertising_buy = new Serializer(
    "advertising_buy",
    {
        fee: fee,
...
export const advertising_confirm = new Serializer(
    "advertising_confirm",
    {
        fee: fee,
        platform: account_uid_type,                 // 平台账号
...
export const advertising_ransom = new Serializer(
    "advertising_ransom",
    {
        fee: fee,
        from_account: account_uid_type,
...
export const custom_vote_create = new Serializer(
    "custom_vote_create",
    {
        fee: fee,
...
export const custom_vote_cast = new Serializer(
    "custom_vote_cast",
    {
        fee: fee,
...
export const balance_lock_update = new Serializer(
    "balance_lock_update",
    {
        fee: fee,
        account: account_uid_type,
...
export const pledge_mining_update = new Serializer(
    "pledge_mining_update",
    {
        fee: fee,
        pledge_account: account_uid_type,
        witness:account_uid_type,
        new_pledge: share_type,
        extensions: optional(future_extensions)
    }
);
export const pledge_bonus_collect = new Serializer(
...
export const market_fee_collect = new Serializer(
    "market_fee_collect",
    {
        fee: fee,
        account: account_uid_type,
        asset_aid: asset_aid_type,
        amount: share_type,
        extensions: optional(future_extensions)
    }
);
export const score_bonus_collect = new Serializer(
    "score_bonus_collect",
    {
        fee: fee,
        account: account_uid_type,
...
export const beneficiary_assign = new Serializer(
    "beneficiary_assign",
    {
        fee: fee,
        owner: account_uid_type,
        new_beneficiary: account_uid_type,
        extensions: optional(future_extensions)
    }
);
export const benefit_collect = new Serializer(
    "benefit_collect",
    {
        fee: fee,
        issuer: account_uid_type,
...
const type_def = new Serializer("type_def",{
    new_type_name:string,
    type_name:string,
});

const field_def = new Serializer('field_def',{
    name:string,
    type:string,
});

const struct_def = new Serializer('struct_def',{
    name:string,
    type:string,
    fields:static_variant(field_def)
});

const action_def = new Serializer('action_def',{
    name:string,
    type:string,
    payable:bool,
});

const table_def = new Serializer('table_def',{
    name:string,
    index_type:string,
...
const error_message = new Serializer('error_message',{
    error_code:uint64,
    error_msg:string
});
...
export const contract_deploy_operation = new Serializer(
...
export const contract_call_operation = new Serializer(
...
operation.st_operations = [
    ...
    contract_call_operation,        // 60 调用合约方法
];
